...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.countryMobileCode, this.userName, this.email,
      this.password, this.mobileNumber, this.profile);
  ...
  @override
  String toString() {
    return 'RegisterObject(countryMobileCode: $countryMobileCode, userName: $userName, email: $email, password: $password, mobileNumber: $mobileNumber, profile: $profile)';
  }
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String password,
      final String mobileNumber,
      final String profile) = _$_RegisterObject;
