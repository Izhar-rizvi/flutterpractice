...
class RegisterViewModel extends BaseViewModel
  ...
  setCountryCode(String countryCode) {
    if (countryCode.isNotEmpty) {
      ...
      registerViewObject = registerViewObject.copyWith(countryMobileCode: "+91");
    }
    _validate();
  }
  ...
  setProfilePicture(File file) {
    ...
    if (file.path.isNotEmpty) {
      ...
      registerViewObject = registerViewObject.copyWith(
          profile: file.path);
      print(file.path);// using data class like kotlin
    } else {
      // reset profilePicture value in register view object
      registerViewObject = registerViewObject.copyWith(profile: "");
    }
    _validate();
  }
